...
//    double_t d = comdata->getPath_mm();
    ui->c_label_posX_value->setText(QString("%1 (%2)[%3]").arg(controller->getPath_mm(X_AXIS,status->coordinatus[X_AXIS])/stepsAxis[X_AXIS])
                                    .arg(status->coordinatus[X_AXIS]).arg(coordinatus->getNextValue(X_AXIS)) );
    ui->c_label_posY_value->setText(QString("%1 (%2)[%3]").arg(controller->getPath_mm(Y_AXIS,status->coordinatus[Y_AXIS])/stepsAxis[Y_AXIS])
                                    .arg(status->coordinatus[Y_AXIS]).arg(coordinatus->getNextValue(Y_AXIS)));
    ui->c_label_posZ_value->setText(QString("%1 (%2)[%3]").arg(controller->getPath_mm(Z_AXIS,status->coordinatus[Z_AXIS])/stepsAxis[Z_AXIS])
