...
public:
    ...
    void setBackgroundColor_ex(const QColor color);
    ModelWorkArea  getModelWorkArea(){ return workArea; }
    void setModelWorkArea(const ModelWorkArea &value);
...
signals:
    void modelFileOpened(Model* model);
